    ...
    return (
        <div className="container">
            ...
            <section className="section">
                ...
                <p id="subtitle" className="-gray">// some of the projects I've worked on</p>
                <div id="projects-container">
                    {projects.map(project => (<div className={styles.project} key={project.fields.title}>
                        ...
                        <div className={styles.details}> <h1 className="-primary"> {project.fields.title} </h1>
                            ...
                            <p> {project.fields.description ?? project.fields.longDescription} </p>
                        </div>
                    </div>))}
                </div>
            </section>
